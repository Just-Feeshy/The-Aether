...
public enum AetherArmorMaterials implements ArmorMaterial {
	...
	VALKYRIE("valkyrie", 33, new int[]{3, 6, 8, 3}, 10, AetherSoundEvents.ITEM_ARMOR_EQUIP_VALKYRIE, 3.0F, () -> Ingredient.of(AetherTags.Items.VALKYRIE_REPAIRING)),
	PHOENIX("phoenix", 33, new int[]{3, 6, 8, 3}, 10, AetherSoundEvents.ITEM_ARMOR_EQUIP_PHOENIX, 3.0F, () -> Ingredient.of(AetherTags.Items.PHOENIX_REPAIRING)),
	OBSIDIAN("obsidian", 37, new int[]{3, 6, 8, 3}, 15, AetherSoundEvents.ITEM_ARMOR_EQUIP_OBSIDIAN, 4.0F, () -> Ingredient.of(AetherTags.Items.OBSIDIAN_REPAIRING)),
